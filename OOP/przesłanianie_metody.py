...
# Gdy tworzysz w klasie pochodnej metodę o takiej samej nazwie jak nazwa metody odziedziczonej, przesłaniasz tę
# odziedziczoną metodę w nowej klasie
...
# super(), pozwala wywołać metodę klasy bazowej (zwanej także nadklasą, ang. superclass)
    # argument, self, przekazuje referencję do nowo
    # utworzonego obiektu klasy Positionable_Card, aby kod klasy Card uzyskał dostęp
    # do obiektu i mógł do niego dodać atrybuty rank i suit
