class Critter(object):
    ...
    def __pass_time(self): # uzytkownik nie powinien miec do niej dostepu
        # bedzie uzyta po kazdej metodzie, ktora cos wykonuje (je, bwai sie, itp)
        self.hunger += 1
        self.boredom += 1

    @property
    # własciwosc udostepnia lancuch zwracany przez metode, ktory nei jest czescia obiektu klasy Critter
    # konwertuje metode do parametru
    def mood(self):
